...
public class BoggleSolver {
    ...
    public BoggleSolver(String[] dictionary) {
        ...
        // Construct the TrieNode as a Symbol Table for word searching
    ...
    // i,j: start char in the board
    // words: put the searched valid words into the HashSet: words.
    // visited: keep track of visited positions in the board, the key point is to set visited[i][j] back to false
